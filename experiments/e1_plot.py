...
from figstyle import tidy, panel, legend_below, INK, INK2
...
fig, (a1, a2) = plt.subplots(1, 2, figsize=(7.0, 3.9), gridspec_kw={"width_ratios": [1.12, 1.0], "wspace": 0.30})
...
a1.axis("off")
a1.set_title("(a) Loading configurations", loc="left",
...
handles, labels = [], []
for key, lab, col, mk in (("scratch", "New network", C_SCRATCH, "o"),
                          ("warm", "Transferred network", C_WARM, "s")):
    rows = r[key]
